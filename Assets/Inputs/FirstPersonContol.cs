    ...
    public struct GameplayControlActions
    {
        ...
        public void SetCallbacks(IGameplayControlActions instance)
        {
            if (m_Wrapper.m_GameplayControlActionsCallbackInterface != null)
            {
                ...
                @PlayerMove.started -= m_Wrapper.m_GameplayControlActionsCallbackInterface.OnPlayerMove;
                @PlayerMove.performed -= m_Wrapper.m_GameplayControlActionsCallbackInterface.OnPlayerMove;
                @PlayerMove.canceled -= m_Wrapper.m_GameplayControlActionsCallbackInterface.OnPlayerMove;
            }
